...
/*
	...
	int tm_hour; //hours of days from 0 to 24
	int tm_mday; //day of month from 0 to 31
...
int main()
{
	...
	cout << "Year Day (Days since Jun 1st): " << now->tm_yday << endl;
